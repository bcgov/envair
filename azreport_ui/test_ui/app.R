#interactive graph of CAAQS metrics
#for each location
...
ui <-  fluidPage(
  titlePanel('Trends of Pollutant Levels'),

  selectInput("Parameter", "Select Pollutant to Display:",
              list(`Parameter` = parameters)
  ),
  uiOutput("stationSelect"),
  # selectInput("Stations2", "Choose the year:",
  #             list(`Station List` = unlist(yearlist))
  # ),
  plotOutput("plot1")
...
#
#       readRDS('C:/OneDrives/OneDrive - Government of BC/Documents/!Working/Air Zone Report Development Process/R_Scripts_Development/Data/pm25.Rds')
#
#   )
# }
